...
**Please note** that this project works with a backend code, which can be viewed at this repository: https://github.com/Gd-godz/policypal-hackathon-backend.git
